package prolog.prtest.primes;

import base.Asserts;
import expression.BaseTest;
import prolog.prtest.PrologScript;
import prolog.prtest.PrologUtil;
...
public class PrologPrimesTest extends BaseTest {
    ...
    public PrologPrimesTest(final int max) {
        this.max = max;
        prolog = new PrologScript("/home/mokaruuns/git/education_itmo/sem_2/paradigms_2020/HW12/src/prolog/prtest/primes/primes" + SUFFIX);
        primes = primes(max);
